    ...
    <div class="row px-4">
        <div class="col-lg-6 justify-content-around ">
            <div class="card h-100">
                ...
                @endif
                @if ($post->isEmpty())
                <h4 class="text-center">No Blogs Created</h4>
                @else
                ...
                <div class="row g-2 px-5 mt-3">
                    ...
                    <div class="col-lg-3"><a href="{{url('blogdetails/')}}/{{$data->post_id}}" class="btn w-100"
                            style="background: #79AC78;">View</a>
                    </div>
                    <div class="col-lg-3"><a href="{{url('blogupdate/')}}/{{$data->post_id}}"
                            class="btn btn-info w-100">Update</a></div>
                    <div class="col-lg-3"><a href="{{url('blogdelete/')}}/{{$data->post_id}}"
